...
Run `npm start` for a dev server. Navigate to `http://localhost:4200/`. The application automatically reloads when source files change.
...
No end-to-end test runner is configured in this application.
