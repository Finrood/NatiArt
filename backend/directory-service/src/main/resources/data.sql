...
INSERT INTO public.users (id, version, username, password_hash, email_confirmed, created_at, updated_at, active, deactivated_at, role_id)
    VALUES
         (
...
INSERT INTO public.profile (id, version, firstname, lastname, cpf, phone, country, state, city, zip_code, street, complement, user_id, created_at, updated_at)
    VALUES (
