 ...
 */
@Retryable(
        retryFor = {HttpServerErrorException.class, ResourceAccessException.class, IOException.class},
        noRetryFor = {HttpClientErrorException.class // Do not retry on 4xx client errors
        },
        maxAttempts = 20,
        backoff = @Backoff(delay = 100, multiplier = 5, maxDelay = 3000000))
