...
class WebConfigTest {
    ...
    void corsFilter_reflectsConfiguredOrigins() {
        ...
        final CorsConfiguration config = source.getCorsConfiguration(new MockHttpServletRequest("GET", "/products"));
    ...
    void corsFilter_allowsCredentials() {
        ...
        final CorsConfiguration config = source.getCorsConfiguration(new MockHttpServletRequest("OPTIONS", "/cart"));
